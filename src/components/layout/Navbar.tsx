        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-[#F5F5F0]/95 backdrop-blur-sm border-b border-[#1A1A1A]/5">
            <div className="px-6 md:px-12 py-6 flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center gap-3">
                    <div className="w-12 h-12 border border-[#1A1A1A]/20 rounded-full flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[#1A1A1A]">
                            <circle cx="12" cy="12" r="8" strokeDasharray="3 3" />
                        </svg>
                    </div>
                    <span className="font-semibold text-[18px] text-[#1A1A1A] hidden sm:block tracking-[-0.01em]">Moonscape Designs</span>
                </Link>
                ...
                <div className="hidden md:block">
                    <Button asChild className="bg-[#1A1A1A] hover:bg-[#333] text-white rounded-none h-11 px-7 text-[15px] font-medium transition-all duration-200">
